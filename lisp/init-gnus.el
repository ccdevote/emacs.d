...
(setq gnus-user-date-format-alist
      '(((gnus-seconds-today) . "%H:%M")
        ((+ (* 24 3600)    (gnus-seconds-today)) . "昨   ")
        ((+ (* 2  24 3600) (gnus-seconds-today)) . "前   ")
        ((gnus-seconds-month) . "%d号 ")
